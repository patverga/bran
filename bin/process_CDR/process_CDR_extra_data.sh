...
python ${CDR_IE_ROOT}/src/processing/labled_tsv_to_tfrecords.py --text_in_files ${processed_dir}/\*tive_\*C\* --out_dir ${proto_dir} --max_len ${max_len} --num_threads 12 --multiple_mentions --tsv_format --min_count ${min_count}
