...
PROCESSED_DIR=${CTD_DIR}/CTD_genia_sentence/
...
--output_file_suffix ${FILE_SUFFIX} --max_seq 5000000  -x True
...
#python src/processing/labled_tsv_to_tfrecords_single_sentences.py --text_in_files ${PROCESSED_DIR}/shards/\*tive\* --out_dir ${PROCESSED_DIR}/protos --max_len ${MAX_LEN} --num_threads 30 --multiple_mentions --tsv_format --min_count ${MIN_COUNT}
#
